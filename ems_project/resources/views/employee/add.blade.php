			...
			<div class="col-md-6 col-md-offset-3">
				<form id="add_form" method="POST" name="add" action="/store" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="employee_id" name="employee_id" placeholder="Nhập mã nhân viên">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="employee_name" name="employee_name" placeholder="Nhập tên nhân viên">
